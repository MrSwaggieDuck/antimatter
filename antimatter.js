...
if(localStorage.hasOwnProperty("antimatter")) {
	var antimatter = parseInt(localStorage.getItem("antimatter"));
	var notation = "scientific"
	var prestige = {
		cost:parseInt(localStorage.getItem("prestigeCost")),
		multiplier:parseInt(localStorage.getItem("prestigeMultiplier"))
	};
	var dimension1 = {
		cost:parseInt(localStorage.getItem("dimension1cost")),
		amount:parseInt(localStorage.getItem("dimension1amount")),
		multiplier:parseInt(localStorage.getItem("dimension1multiplier")),
		next10:parseInt(localStorage.getItem("dimension1next10")),
	};
	var dimension2 = {
		cost:parseInt(localStorage.getItem("dimension2cost")),
		amount:parseInt(localStorage.getItem("dimension2amount")),
		multiplier:parseInt(localStorage.getItem("dimension2multiplier")),
		next10:parseInt(localStorage.getItem("dimension2next10")),
	};
	var dimension3 = {
		cost:parseInt(localStorage.getItem("dimension3cost")),
		amount:parseInt(localStorage.getItem("dimension3amount")),
	multiplier:parseInt(localStorage.getItem("dimension3multiplier")),
		next10:parseInt(localStorage.getItem("dimension3next10")),
	};
	var dimension4 = {
		cost:parseInt(localStorage.getItem("dimension4cost")),
		amount:parseInt(localStorage.getItem("dimension4amount")),
		multiplier:parseInt(localStorage.getItem("dimension4multiplier")),
		next10:parseInt(localStorage.getItem("dimension4next10")),
	};
	var dimension5 = {
		cost:parseInt(localStorage.getItem("dimension5cost")),
		amount:parseInt(localStorage.getItem("dimension5amount")),
		multiplier: parseInt(localStorage.getItem("dimension5multiplier")),
		next10:parseInt(localStorage.getItem("dimension5next10")),
	};
	var dimension6 = {
		cost:parseInt(localStorage.getItem("dimension6cost")),
		amount:parseInt(localStorage.getItem("dimension6amount")),
		multiplier: parseInt(localStorage.getItem("dimension6multiplier")),
		next10:parseInt(localStorage.getItem("dimension6next10")),
	};
	var dimension7 = {
		cost:parseInt(localStorage.getItem("dimension7cost")),
		amount:parseInt(localStorage.getItem("dimension7amount")),
		multiplier: parseInt(localStorage.getItem("dimension7multiplier")),
		next10:parseInt(localStorage.getItem("dimension7next10")),
	};
	var dimension8 = {
		cost:parseInt(localStorage.getItem("dimension8cost")),
		amount:parseInt(localStorage.getItem("dimension8amount")),
		multiplier: parseInt(localStorage.getItem("dimension8multiplier")),
		next10:parseInt(localStorage.getItem("dimension8next10")),
	};
} else {
	var antimatter = 10;
	var notation = "scientific";
...
function update() {
	...
	document.querySelector("#antimatterPerSec").innerHTML = "+" + convert(dimension1.amount*dimension1.multiplier) + " Antimatter per sec";
//Notation
